...
\input{AreaMinimizingHypersurfaces}

\section{The logarithmic cutoff trick for \texorpdfstring{$n=2$}{n=2}}
\input{Logarithmic cutoff trick}

\section{Area minimizing cones}
\input{Area minimizing cones}

\section{Solution to the Bernstein problem}
\input{Tangent cones at infinity}
